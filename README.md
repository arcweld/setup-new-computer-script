...
if type brew &>/dev/null; then
  PKG_MAN_PREFIX="$(brew --prefix)"
  if [[ -r "${PKG_MAN_PREFIX}/etc/profile.d/bash_completion.sh" ]]; then
    source "${PKG_MAN_PREFIX}/etc/profile.d/bash_completion.sh"
  else
    for COMPLETION in "${PKG_MAN_PREFIX}/etc/bash_completion.d/"*; do
