...
# Install basic laptop utilities
    if [[ "${devtoolchoices[0]}" == "+" ]]; then
      ...
      printStep "Zoom"                        "wget https://zoom.us/client/latest/zoom_amd64.deb --output-document=./zoom_amd64.deb"
      printStep "  Zoom"                      "sudo apt install ./zoom_amd64.deb"
      printStep "    Zoom"                    "rm ./zoom_amd64.deb"
...
# Install advanced laptop utilities
    if [[ "${devtoolchoices[1]}" == "+" ]]; then
      ...
      printHeading "Installing laptop utilities"
...
printDivider
    echo "✔ Set Git to store credentials"
